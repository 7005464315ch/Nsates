...
class superregController extends Controller
{
    public function superreg() {
         
        return view('admin.superreg');
    }

    public function supereg(Request $request){
         $unique_no = superadmin::orderBy('id', 'DESC')->pluck('id')->first();
       ...
       $staff->sadmin_code = 'SADMIN00'.$unique_no;
