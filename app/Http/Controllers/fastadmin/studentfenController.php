...
class studentfenController extends Controller
{
    public function studentfen() {
            $datao = array();
        ...
        return view('fastadmin.studentfen',compact('datao'));
    }
    ...
    public function sstudentsec(Request $ssearch){
        $datao = array();
        if (session::has('fadminid')) {
            $datao = fastadmin::where('id','=',session::get('fadminid'))->first();
        ...
        {
    //dd($registrations);
      return view('fastadmin.studentfen',compact('datao'))->with('registrations', $registrations);
...
return view('fastadmin.studentfen',compact('datao'))->with('stuff_notfound','No Data Found');
     ...
     public function fstudenten(Request $request){
