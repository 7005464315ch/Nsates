...
<table class="table table-bordered table-hover">
  ...
  <tbody>
    @foreach($studentens as $key=>$studenten)
    <tr>
      <td scope="row">{{++$key}}</td>
      <td>{{$studenten->student_entry_code}}</td>
      <td>{{$studenten->created_date}}</td>
      <td>{{$studenten->full_name}}</td>
      <td>{{$studenten->phone_no}}</td>
      <td>{{$studenten->email}}</td>
      <td>{{$studenten->state}}</td>
      <td><a data-studenten_id="{{$studenten->id}}"
           data-created_date="{{$studenten->created_date}}"
           data-student_entry_code="{{$studenten->student_entry_code}}"
           data-student_code="{{$studenten->student_code}}"
           data-student_no="{{$studenten->student_no}}"
           data-reg_no="{{$studenten->reg_no}}"
           data-dsecp="{{$studenten->dsecp}}"
           data-full_name="{{$studenten->full_name}}"
           data-department_name="{{$studenten->department_name}}"
           data-hostel_no="{{$studenten->hostel_no}}"
           data-room_no="{{$studenten->room_no}}"
           data-admission_years="{{$studenten->admission_years}}"
           data-gender="{{$studenten->gender}}"  
           data-dob="{{$studenten->dob}}"
           data-phone_no="{{$studenten->phone_no}}"
           data-email="{{$studenten->email}}"  
           data-state="{{$studenten->state}}"
           data-country="{{$studenten->country}}"
           data-zipcode="{{$studenten->zipcode}}"
           data-other_info="{{$studenten->other_info}}"
           data-upload_date="{{$studenten->upload_date}}"
           data-toggle="modal" data-target="#exampleModal-show" 
          type="button"class="btn btn-warning btn-sm">View</a></td>   
    </tr>
    @endforeach
  </tbody>
</table>
