@extends('admin.cadmin')
   ...
   <link rel="stylesheet" type="text/css" href="{{asset('asset/css/table-style.css')}}">
    <h2>Admin Staff  Reports</h2>
    <div class="container table-responsive py-5"> 
     <div class="col-sm-6">
             <form action="{{url('viewadstaffcode')}}" method="post">
               @csrf
          ...
          <div class="col-sm-6">
             <form action="{{url('viewadstaffdate')}}" method="post">
               @csrf
  ...
  <tbody>
    ...
    <tr>
        <td scope="row">{{++$key}}</td>
        <td id="bm-2">{{$staffa->fadmin_code}}</td>
      ...
      <div class="modal-body" style="height: 500px;">
        <form action="{{url('showrep','id')}}" method="get">
          ...
          <div class="col-sm-3 form-group" >
                ...
                <input type="text" class="form-control" id="fadmin_code" disabled>
            </div>
            ...
            <div class="col-sm-3 form-group" id="cx-19">
...
<script type="text/javascript">
   $('#exampleModal-showzc').on('show.bs.modal', function(event){
               ...
               var fadmin_code = button.data('fadmin_code')
               ...
               modal.find('.modal-body #fadmin_code').val(fadmin_code);
