@extends('admin.cadmin')
   @section('contentx')
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
            <div class="col-sm-0">
            <h2 class="text-center">Fastadmin Registration</h2>
        <div class="row jumbotron">
            <form action="{{url('fadminreg')}}" method="POST" enctype="multipart/form-data" style="width:100%">
            @csrf
            ...
            <div class="col-sm-6 form-group">
                ...
                <input type="file" name="fadmin_pic" class="form-control" id="picture"  required>
            </div>
            <div class="col-sm-12">
