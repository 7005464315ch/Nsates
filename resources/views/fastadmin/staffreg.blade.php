   ...
   @section('contentz')
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
        ...
        <div class="row jumbotron">
            <form action="{{url('staffregs')}}" method="POST" enctype="multipart/form-data" style="width:100%">
            @csrf
            ...
            <div class="col-sm-12 form-group mb-0">
               <button class="btn btn-primary float-right"  data-toggle="modal" data-target="#exampleModal">Submit</button>
            </div>  </form>
            </div>
       </div>
