@extends('fastadmin.fastadmin')
   @section('contentz')
   <link rel="stylesheet" type="text/css" href="{{asset('asset/css/fastadminstaff-style.css')}}">
   
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
            <div class="col-sm-0">
            <h2 class="text-center">Staff Entry Area</h2>
        <div class="row jumbotron">
            <form action="{{url('faststaffen')}}" method="GET" style="width: 100%;">
            @csrf
            ...
            <form action="{{url('faststaffonenx')}}" method="POST" style="width:100%">
            @csrf
