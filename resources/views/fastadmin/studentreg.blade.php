   ...
   @section('contentz')
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
        ...
        <div class="row jumbotron">
            <form action="{{url('studentadreg')}}" method="POST" enctype="multipart/form-data" style="width:100%">
            @csrf
            ...
            <div class="col-sm-3 form-group">
                ...
                <input type="text" class="form-control" name="student_no" id="student_no" placeholder="Enter Student No." required>
            </div>
             <div class="col-sm-3 form-group">
             ...
             <div class="col-sm-2 form-group">
                ...
                <input type="text" class="form-control" name="hostel_no" id="hostel_no" placeholder="Enter Hostel No." >
            </div>
             <div class="col-sm-2 form-group">
             ...
             <div class="col-sm-2 form-group">
                <label for="admission_year">AD years</label>
                <input type="text" class="form-control" name="admission_year" id="admission_year" placeholder="Addmission yr." >
            </div>
