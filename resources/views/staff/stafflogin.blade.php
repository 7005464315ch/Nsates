    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5" style="">
          ...
          <form method="POST" action="{{url('stafflog')}}" style="width: 23rem;">
            @csrf
            <br>
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in</h3>

            <div class="form-outline mb-4">
              <input type="text" id="form2Example18" class="form-control form-control-lg" name="employee_no" />
      ...
      <div class="col-sm-6 px-0 d-none d-sm-block">
        <img src="{{asset('asset/media/staff2.jpg')}}"
