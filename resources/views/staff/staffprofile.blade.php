         ...
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="form-group">
               <label for="phone">Staff Code</label>
              <!--  <input type="text" class="form-control" id="phone" value="{{$datao->phone_no}}"> -->
              <label class="form-control" id="phone">{{$datao->staff_code}}</label>
            </div>
         </div>
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="form-group">
               <label for="phone">Employee No( Roll No )</label>
               <label class="form-control" id="phone">{{$datao->employee_no}}</label>
              <!--  <input type="text" class="form-control" id="phone" value="{{$datao->phone_no}}"> -->
            </div>
         </div>
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="form-group">
               <label for="phone"> Year</label>
                <label class="form-control" id="phone">None</label>
               <!-- <input type="text" class="form-control" id="phone" value="{{$datao->phone_no}}"> -->
            </div>
         </div>
         <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
            <div class="form-group">
               <label for="phone">Post</label>
                <label class="form-control" id="phone">{{$datao->post}}</label>
              <!--  <input type="text" class="form-control" id="phone" value="{{$datao->phone_no}}"> -->
            </div>
         </div>
