@extends('staff.staffdesh')
   @section('contentrsx')
   <link rel="stylesheet" type="text/css" href="{{asset('asset/css/staffonstaff-stylesheet.css')}}">
   
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js"></script>
            <div class="col-sm-0">
            <h2 class="text-center">Staff Entry Area</h2>
        <div class="row jumbotron">
            <form action="{{url('sstaffen')}}" method="GET" style="width: 100%;">
            @csrf

            <div class="col-sm-3 form-group" id="fast-one-div">
                <label for="name-f">Enter Staff ID/Employee No</label>
            ...
            <form action="{{url('sstaffonenx')}}" method="POST" style="width:100%">
            @csrf
            ...
            <div class="col-sm-3 form-group">
                ...
                <input type="text" class="form-control" name="staff_code" id="staff_code" value="{{$registrations->staff_code}}" required>
            </div>

            <div class="col-sm-3 form-group">
                <label for="student_no">Staff ID/Employee No</label>
                <input type="text" class="form-control" name="employee_no" id="student_no" value="{{$registrations->employee_no}}" required>
            </div>

            <div class="col-sm-3 form-group">
                <label for="reg_no">Staff Post</label>
                <input type="text" class="form-control" name="post" id="reg_no" value="{{$registrations->post}}" required>
            </div>
            ...
            <div class="col-sm-2 form-group">
                <label for="hostel_no">Gender</label>
                <input type="text" class="form-control" name="gender" id="hostel_no" value="{{$registrations->gender}}" required>
            </div>
            ...
            <div class="col-sm-3 form-group">
                ...
                <input type="text" class="form-control" name="phone_no" id="phone_no" value="{{$registrations->phone_no}}" required>
            </div>
            <div class="col-sm-6 form-group">
                <label for="address">Address</label>
                <textarea type="text" name="address" class="form-control" id="address" required>{{$registrations->address_one}}</textarea>
            </div>
            <div class="col-sm-6 form-group">
                <label for="address_two">Address</label>
                <textarea type="text" name="address_two" class="form-control" id="address_two"  required>{{$registrations->address_two}}</textarea>
            </div>
            <div class="col-sm-3 form-group">
...
{{$stuff_notfound}}
 @endif
    ...
    <div class="col-sm-12 form-group mb-0" id="fast-one-div-3">
            ...
            <div class="col-sm-3 form-group">
                <label for="student_code">Staff Code</label>
                <input type="text" class="form-control" name="staff_code" id="student_code" placeholder="Student Code." required>
            </div>

            <div class="col-sm-3 form-group">
                <label for="student_no">Staff ID/Employee No</label>
                <input type="text" class="form-control" name="student_no" id="student_no" placeholder="Staff ID/Employee No." required>
            </div>
